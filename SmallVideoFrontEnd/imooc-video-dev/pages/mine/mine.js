...
Page({
  ...
  onLoad: function (params) {
    ...
    var user = app.getGlobalUserInfo();//todo
    var userId = user.id;
  ...
  followMe: function (e) {
    ...
    if (followType == '1') {
      ...
      url = '/user/notyourfan?userId=' + publisherId + '&fanId=' + userId;
    }
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.status == 200) {
          ...
          // app.userInfo = null;
          // 注销以后，清空缓存
          wx.removeStorageSync("userInfo")//todo
          // 页面跳转
          wx.redirectTo({
            url: '../userLogin/login',
          })
  ...
  changeFace: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        // fixme 修改原有的全局对象为本地缓存
        var userInfo = app.getGlobalUserInfo();//todo
